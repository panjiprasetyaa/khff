...
export const BOOKING_EVENTS: BookingEvent[] = [
  // --- 1. PROGRAM KOMPETISI (Karya Pelajar, Pemerintah, & Independen) ---
  {
    ...
    category: "Kompetisi",
    title: "Kompetisi: Purwaseswa (Karya Pelajar)",
  ...
  },
  {
    ...
    programLabel: "Program Kompetisi",
    category: "Kompetisi",
    title: "Kompetisi: Karyanagri (Karya Pemerintah/Nasional)",
  ...
  },
  {
    ...
    programLabel: "Program Kompetisi",
    category: "Kompetisi",
    title: "Kompetisi: Mahaditya (Karya Independen)",
  ...
  },
  {
    ...
    subtitle: "Garden Amidst the Flame & Tunggang Langgang (Afterlives)",
    scheduleDate: "Sabtu, 19 September 2026",
    scheduleTime: "19.15 WIB",
    venue: "Ruang Seminar PDIN",
    venueDetail: "Pusat Desain Industri Nasional (PDIN), Jl. Terban",
  ...
  },
  {
    ...
    subtitle: "Zaki Habibi (Akademisi & Pengkaji Film KHFF)",
    scheduleDate: "Sabtu, 19 September 2026",
    scheduleTime: "15.30 WIB",
    venue: "Ruang Kaca Bawah (Selatan) PDIN",
    venueDetail: "Pusat Desain Industri Nasional (PDIN), Jl. Terban",
