  ...
  return (
    <main className="min-h-screen pt-32 pb-24 bg-khff-navy text-khff-cream relative overflow-hidden font-sans">
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        <div className="text-center md:text-left mb-16 border-b border-khff-cream/10 pb-12">
          <span className="text-xs md:text-sm uppercase tracking-[0.3em] text-khff-yellow font-mono font-bold block mb-4">
            Kotabaru Heritage Film Festival 2026
          </span>
          <h1 className="text-5xl md:text-8xl font-serif font-black text-khff-cream mb-6 tracking-tight">
            Programs.
          </h1>
          <p className="text-khff-cream/80 text-lg md:text-2xl max-w-3xl font-medium leading-relaxed">
        ...
        <div className="grid grid-cols-1 gap-12">
          {mainCategories.map((category) => (
            <Link key={category.id} href={`/program/${category.id}`} className="block group">
              <div className={`rounded-3xl p-8 md:p-12 transition-all duration-500 relative overflow-hidden shadow-2xl border-4 group-hover:-translate-y-2 ${category.bgClass}`}>
                ...
                <div className="relative z-10 max-w-4xl">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className={`text-xs font-mono font-black uppercase tracking-widest px-4 py-1.5 rounded-full ${category.tagClass}`}>
                      {category.subtitle}
                    </span>
                  </div>
                  ...
                  <div className="inline-flex items-center gap-4 text-base md:text-lg font-mono font-black py-4 px-8 rounded-2xl bg-black/10 hover:bg-black/20 backdrop-blur-md transition-all">
