  ...
  return (
    <main className="min-h-screen pt-32 pb-24 bg-black flex items-center justify-center">
      <div className="container mx-auto px-6 text-center">
        <ImageIcon size={64} className="text-white/20 mx-auto mb-6" />
        <h1 className="text-5xl md:text-7xl font-serif font-bold text-white mb-6">
          Galeri Dokumentasi
        </h1>
        <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-12">
          Halaman ini akan memuat seluruh arsip visual dan dokumentasi kegiatan Kotabaru Heritage Film Festival.
        </p>
